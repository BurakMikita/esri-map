import{a as l}from"./chunk-PIAEM5HF.js";import{a as p}from"./chunk-O6MDTSVU.js";import{a as x}from"./chunk-DK3KECNU.js";import{a as P}from"./chunk-2OFKI5R7.js";import{a as s}from"./chunk-B2KD3GMI.js";import{a as i}from"./chunk-ZMBCTCSM.js";import{G as y,c as v,h as u,n as m,u as h,v as g,x as w}from"./chunk-G3M47L72.js";import{a as c,c as d}from"./chunk-JARU7KSM.js";function z(o){let e=new P;return e.attributes.add("position","vec3"),e.attributes.add("instanceFeatureAttribute","float"),e.vertex.uniforms.add(new l("cameraPosition",t=>t.camera.eye),new x("offset",(t,a)=>q(t,a)),new s("width",t=>t.width),new s("time",t=>t.time),new p("proj",t=>t.camera.projectionMatrix),new p("view",t=>t.camera.viewMatrix)),e.varyings.add("vUv","vec2"),e.vertex.code.add(i`vec3 hash31(float p){
...
return 2.0 * cross(q.xyz, v * q.w + cross(q.xyz, v)) + v;
      ...
      `}
  `),e.fragment.uniforms.add(new s("opacity",t=>t.opacity),new l("particleColor",t=>A(t,o))),e.fragment.main.add(i`
