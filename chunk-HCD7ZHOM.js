import{a}from"./chunk-JXKPIB3A.js";import{a as o}from"./chunk-ZMBCTCSM.js";function n(e){e.code.add(o`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
...
}`)}function c(e,t){e.include(a),t.pbrMode!==1&&t.pbrMode!==2&&t.pbrMode!==5&&t.pbrMode!==6||(e.code.add(o`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)),t.pbrMode!==1&&t.pbrMode!==2||(e.include(n),e.code.add(o`struct PBRShadingInfo
{
float NdotV;
float LdotH;
float NdotNG;
...
}`))}function u(e,t){e.include(a),e.code.add(o`
